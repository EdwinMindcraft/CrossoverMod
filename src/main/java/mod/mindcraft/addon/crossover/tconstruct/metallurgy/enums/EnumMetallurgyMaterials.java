...
public enum EnumMetallurgyMaterials {
	...
	public static EnumMetallurgyMaterials[] getMaterialList () {
		
		EnumMetallurgyMaterials[] matList = { MATERIAL_MANGANESE,
				MATERIAL_HEPATIZON, MATERIAL_DAMASCUSSTEEL, MATERIAL_ANGMALLEN,
				MATERIAL_EXIMITE, MATERIAL_MEUTOITE, MATERIAL_DESICHALKOS,
				MATERIAL_PROMETHEUM, MATERIAL_DEEPIRON, MATERIAL_INFUSCOLIUM,
				MATERIAL_BLACKSTEEL, MATERIAL_OURECLASE, MATERIAL_ASTRALSILVER,
				MATERIAL_CARMOT, MATERIAL_MITHRIL, MATERIAL_RUBRACIUM,
				MATERIAL_QUICKSILVER, MATERIAL_HADEROTH, MATERIAL_ORICHALCUM,
				MATERIAL_CELENEGIL, MATERIAL_ADAMANTINE, MATERIAL_ALTARUS,
				MATERIAL_TARTARITE, MATERIAL_IGNATUS, MATERIAL_SHADOWIRON,
				MATERIAL_LEMURITE, MATERIAL_MIDASIUM, MATERIAL_VYROXERES,
				MATERIAL_CERUCLASE, MATERIAL_ALDUORITE, MATERIAL_KALENDRITE,
				MATERIAL_VULCANITE, MATERIAL_SANGUINITE, MATERIAL_SHADOWSTEEL,
				MATERIAL_INOLASHITE, MATERIAL_AMORDRINE, MATERIAL_ZINC,
				MATERIAL_BRASS, MATERIAL_PLATINIUM };
